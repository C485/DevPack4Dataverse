    ...
    public static class IOrganizationServiceAsyncExtension
    {
        ...
        )
        {
            await Guard
                ...
                .ExtDeleteRecordAsync(entityReference.LogicalName, entityReference.Id, requestSettings);
        }

        public static async Task<Entity> ExtCreateRecordAndGetAsync(
            this IOrganizationServiceAsync organizationService,
            Entity record,
            RequestImpersonateSettings? requestSettings = null
        )
        {
            Guid createdRecordId = await Guard
                .Against
                .Null(organizationService)
                .ExtCreateRecordAsync(record, requestSettings);
            ...
            return await Guard
                .Against
                .Null(organizationService)
                .ExtRetrieveAsync(record.LogicalName, createdRecordId, columns);
        }

        public static async Task<Guid> ExtCreateRecordAsync(
            this IOrganizationServiceAsync organizationService,
            Entity record,
            RequestImpersonateSettings? requestSettings = null
        )
        {
            ...
            CreateResponse? createResponse = await Guard
                .Against
                .Null(organizationService)
                .ExtExecuteAsync<CreateResponse>(createRequest, requestSettings);
            return Guard.Against.Null(createResponse).id;
        }

        public static async Task ExtDeleteRecordAsync(
            this IOrganizationServiceAsync organizationService,
            string logicalName,
            Guid id,
            RequestImpersonateSettings? requestSettings = null
        )
        {
            ...
            _ = await Guard
                .Against
                .Null(organizationService)
                .ExtExecuteAsync<DeleteResponse>(deleteRequest, requestSettings);
        }

        public static async Task<T?> ExtDrillRetrieveAsync<T>(
            this IOrganizationServiceAsync organizationService,
            EntityReference obj,
            string path,
        ...
        )
        {
            ...
            return await Guard
                .Against
                .Null(organizationService)
                .ExtDrillRetrieveAsync<T>(obj, noThrowWhenNull, pathParts);
        }
        ...
        )
        {
            ...
            for (int i = 0; i < pathParts.Length; i++)
            {
                ...
                Entity ret = await organizationService.RetrieveAsync(
        ...
        public static async Task<T?> ExtExecuteAsync<T>(
            this IOrganizationServiceAsync organizationService,
            ...
            where Response : OrganizationResponse
        {
            ...
            return await Guard
                .Against
                .Null(organizationService)
                .ExtExecuteAsync<Response>(executeMultipleRequestBuilder.Build(), requestSettings);
        }

        public static async Task<ExecuteMultipleResponse?> ExtExecuteAsync(
            this IOrganizationServiceAsync organizationService,
        ...
        )
        {
            ...
            return await Guard
                .Against
                .Null(organizationService)
                .ExtExecuteAsync<ExecuteMultipleResponse>(executeMultipleRequestBuilder.Build(), requestSettings);
        }

        public static async Task<T?> ExtRefreshRecordAsync<T>(
            this IOrganizationServiceAsync organizationService,
            T record,
            RequestImpersonateSettings? requestSettings = null
        )
            where T : Entity
        {
            ...
            return await Guard
                .Against
                .Null(organizationService)
                .ExtRetrieveAsync<T>(record.LogicalName, record.Id, columns, requestSettings);
        }

        public static async Task<Entity> ExtRefreshRecordAsync(
            this IOrganizationServiceAsync organizationService,
            Entity record,
            RequestImpersonateSettings? requestSettings = null
        )
        {
            ...
            return await Guard
                .Against
                .Null(organizationService)
                .ExtRetrieveAsync(record.LogicalName, record.Id, columns, requestSettings);
        }

        public static async Task<Entity> ExtRetrieveAsync(
            this IOrganizationServiceAsync organizationService,
            string entityName,
            Guid id,
            ColumnSet columnSet,
        ...
        )
        {
            ...
            RetrieveResponse? retrieveResponse = await Guard
                .Against
                .Null(organizationService)
                .ExtExecuteAsync<RetrieveResponse>(
                    new RetrieveRequest
                    {
                        ColumnSet = columnSet,
        ...
        public static async Task<T?> ExtRetrieveAsync<T>(
            this IOrganizationServiceAsync organizationService,
            string entityName,
            Guid id,
            ColumnSet columnSet,
            ...
            where T : Entity
        {
            return await Guard
                .Against
                .Null(organizationService)
                .ExtRetrieveAsync(entityName, id, columnSet, requestSettings)
                .ContinueWith(p => p.Result?.ToEntity<T>());
        }

        public static async Task<Entity[]> ExtRetrieveMultipleAsync(
            this IOrganizationServiceAsync organizationService,
        ...
        )
        {
            ...
            async IAsyncEnumerable<Entity> InnerRetrieveMultiple()
            {
                ...
                while (true)
                {
                    RetrieveMultipleResponse? retrieveMultipleResponse = await Guard
                        .Against
                        .Null(organizationService)
                        .ExtExecuteAsync<RetrieveMultipleResponse>(
        ...
        public static async Task<T[]> ExtRetrieveMultipleAsync<T>(
            this IOrganizationServiceAsync organizationService,
            QueryExpression queryExpression,
            RequestImpersonateSettings? requestSettings = null
        )
        ...
        public static async Task<bool> ExtTestAsync(this IOrganizationServiceAsync organizationService)
        {
            try
            {
                WhoAmIResponse response = (WhoAmIResponse)
                    await Guard.Against.Null(organizationService).ExecuteAsync(new WhoAmIRequest());
        ...
        public static async Task<EntityReference> UpsertRecordAsync(
            this IOrganizationServiceAsync organizationService,
            Entity record,
            RequestImpersonateSettings? requestSettings = null
        )
        {
            ...
            UpsertResponse? executeResponse = await Guard
                .Against
                .Null(organizationService)
                .ExtExecuteAsync<UpsertResponse>(request, requestSettings);
