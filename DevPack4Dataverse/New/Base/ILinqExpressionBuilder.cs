...
public interface ILinqExpressionBuilder<U> where U : Entity, new()
{
    ...
    /// <summary>
    ///     Adds <see cref="ILinqExpressionBuilder{U}" /> expression as new AND block to top of
    ///     <see cref="ILinqExpressionBuilder{U}" />.
    /// </summary>
    ...
    ///     Exception thrown when maximum limit is exceeded or
    ///     <paramref name="expressionToAdd" /> is empty.
    /// </exception>
    ...
    /// <summary>
    ///     Adds <see cref="ILinqExpressionBuilder{U}" /> expression as new OR block to top of
    ///     <see cref="ILinqExpressionBuilder{U}" />.
    /// </summary>
    /// <param name="expressionToAdd">Instance of <see cref="ILinqExpressionBuilder{U}" />, cannot be empty or null.</param>
    /// <exception cref="ArgumentNullException">Exception thrown when <paramref name="expressionToAdd" /> is null.</exception>
